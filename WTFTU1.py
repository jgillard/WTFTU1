...
@app.route('/')
def start():
    return "2L%s\n2U%s" % (findTime(timetableUni), findTime(timetableLeam))


# leaving from uni
uniWeekday = [754, 824, 908, 938, 1008, 1038, 1108, 1138, 1208,
              1238, 1308, 1338, 1408, 1438, 1508, 1538, 1608, 1638, 1708,
              1738, 1808, 1838, 1914, 2014, 2114, 2239]
uniSat = [816, 846, 916, 946, 1016, 1046, 1116, 1146, 1216, 1246,
          1316, 1346, 1416, 1446, 1516, 1546, 1616, 1646, 1716, 1746, 1816,
          1910, 2010, 2110, 2239]
uniSun = [920, 940, 1000, 1020, 1040, 1100, 1120, 1140, 1200, 1220,
